...
module.exports = {
  ...
  find: {
    ...
    summary: 'list congress abstracts',
    parameters: [
      params.$any,
      params.$limit,
      params.$skip,
  ...
  create: {
    ...
    description: 'Creates a new abstracts', 
    summary: 'Create a new abstract [admin role]',
    parameters: [
      params.user
    ],
    responses: {
  ...
  update: {
    id: 'id',
    summary: 'Update a abstract [admin role]',
    parameters:[],
    responses: {
  ...
  patch: {
    id: 'id',
    summary: 'Patch a abstract [admin role]',
    parameters:[],
    responses: {
      '200': responses.success,
      '404': responses.notFound
  ...
  remove: {
    description: 'Remove a abstract',
    summary: 'Remove an abstract [admin role]',
    responses: {
      '200': responses.success,
      '404': responses.notFound
    },
